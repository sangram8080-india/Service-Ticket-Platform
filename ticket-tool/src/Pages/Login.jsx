...
import { useNavigate, Link } from "react-router-dom";
import { useAuth } from '../context/AuthContext';
import { FaRobot, FaTimes, FaPaperPlane, FaPlay, FaPause } from "react-icons/fa";
...
const Login = () => {
  ...
  return (
    <Container fluid className="login-container p-0">
        ...
        <Col lg={5} className="p-0 login-form-section">
          <div className="h-100 d-flex align-items-center justify-content-center py-5">
            <motion.div
              ...
              style={{ maxWidth: '450px', padding: '0 2rem' }}
            >
              {/* Header */}
              <div className="text-center mb-5">
                <div className="form-icon mb-3">
                  <i className="bi bi-person-badge" style={{ fontSize: '2.5rem', color: '#F7941D' }}></i>
                </div>
                <h2 className="fw-bold mb-2" style={{ color: '#1A202C', fontSize: '1.8rem' }}>ENTERPRISE PORTAL</h2>
                ...
                <Tab eventKey="employee" title={
                  ...
                  <Form onSubmit={(e) => handleSubmit(e, false)} className="mt-4">
                    ...
                    <Button
                      variant="primary"
                      type="submit"
                      className="w-100 custom-btn py-3"
                      disabled={isLoading}
                    >
                      {isLoading ? (
                        <>
                ...
                <Tab eventKey="user" title={
                  ...
                  <Form onSubmit={(e) => handleSubmit(e, true)} className="mt-4">
                    ...
                    <div className="form-footer text-center mt-4">
                      ...
                      <span className="divider mx-2 text-muted">•</span>
              ...
              <div className="support-info text-center mt-5 pt-4 border-top">
      ...
      {/* Chatbot Widget */}
      <motion.div
        className={`chatbot-widget ${chatbotOpen ? 'open' : ''}`}
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
      ...
      <style>{`
        ...
        .video-overlay {
          ...
          width: 100%;
          height: 100%;
          background: linear-gradient(135deg, rgba(247, 148, 29, 0.1) 0%, rgba(58, 67, 86, 0.6) 100%);
        }
