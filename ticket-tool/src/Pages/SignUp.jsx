...
import '../Styles/SignUp.css';
import RegisterImage from "../Images/1.png";
import { FaLock, FaUser, FaEnvelope, FaPhone, FaShieldAlt, FaArrowLeft } from 'react-icons/fa';
  ...
  return (
    <div className="min-vh-100 bg-light">
      <Row className="m-0 min-vh-100">
        ...
        <Col lg={7} className="p-0 d-none d-lg-block">
          ...
          >
            ...
            <motion.div
              ...
              className="text-center"
            >
              <h1 className="display-5 fw-bold mb-3">ENTERPRISE SOLUTIONS</h1>
              <p className="lead mb-4 opacity-75">Global IT Support Platform</p>
            ...
            <motion.div
              ...
              animate={{ opacity: 1 }}
              transition={{ duration: 1, delay: 0.8 }}
              className="mt-auto p-4 text-center w-100"
            >
              <p className="small opacity-75 mb-1">© 2024 Enterprise Solutions Inc.</p>
              <p className="small opacity-50">v2.4.1 • Secure Connection • ISO 27001 Certified</p>
            </motion.div>
        ...
        <Col lg={5} className="p-0 bg-white">
            ...
            >
              ...
              <div className="text-center mb-4">
                <motion.div
                  ...
                  transition={{ duration: 0.5 }}
                >
                  <h3 className="fw-bold mb-2" style={{ color: '#1a202c' }}>USER ACCESS PORTAL</h3>
                  <p className="text-muted small">Register for enterprise system access</p>
                </motion.div>
              </div>
              ...
              {error && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mb-4">
                  <Alert variant="danger" className="rounded-2 border-0 py-2">
                    <div className="d-flex align-items-center">
                      <i className="bi bi-x-circle-fill me-2"></i>
                      <span className="small">{error}</span>
                    </div>
              ...
              {success && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mb-4">
                  <Alert variant="success" className="rounded-2 border-0 py-2">
                    <div className="d-flex align-items-center">
                      <i className="bi bi-check-circle-fill me-2"></i>
                      <span className="small">{success}</span>
                    </div>
              ...
              <Form onSubmit={handleSubmit}>
                <Form.Group className="mb-3">
                  <Form.Label className="fw-medium text-dark mb-2">FULL NAME *</Form.Label>
                  <div className="position-relative">
                    <Form.Control
                      ...
                      placeholder="Enter your full name"
                      required
                      className="py-2 px-4 ps-5 rounded-2"
                      style={{ border: '1px solid #e2e8f0' }}
                    />
                    <FaUser className="position-absolute" style={{ top: '50%', left: '16px', transform: 'translateY(-50%)', color: '#a0aec0' }} />
                  </div>
                </Form.Group>

                <Form.Group className="mb-3">
                  <Form.Label className="fw-medium text-dark mb-2">CORPORATE EMAIL *</Form.Label>
                  <div className="position-relative">
                    <Form.Control
                      type="email"
                      name="email"
                      ...
                      style={{ border: '1px solid #e2e8f0' }}
                    />
                    <FaEnvelope className="position-absolute" style={{ top: '50%', left: '16px', transform: 'translateY(-50%)', color: '#a0aec0' }} />
                  </div>
                </Form.Group>

                <Form.Group className="mb-3">
                  <Form.Label className="fw-medium text-dark mb-2">CONTACT NUMBER *</Form.Label>
                  <div className="position-relative">
                    <Form.Control
                      type="tel"
                      name="phone"
                      ...
                      style={{ border: '1px solid #e2e8f0' }}
                    />
                    <FaPhone className="position-absolute" style={{ top: '50%', left: '16px', transform: 'translateY(-50%)', color: '#a0aec0' }} />
                  </div>
                </Form.Group>
                ...
                <Form.Group className="mb-3">
                  ...
                  <div className="position-relative">
                    <Form.Control
                      ...
                      style={{ border: '1px solid #e2e8f0' }}
                    />
                    <FaLock className="position-absolute" style={{ top: '50%', left: '16px', transform: 'translateY(-50%)', color: '#a0aec0' }} />
                  </div>
                ...
                <Button
                  type="submit"
                  variant="primary"
                  className="w-100 py-2 rounded-2 fw-medium"
                  disabled={loading}
                  style={{
              ...
              <div className="text-center mt-4 pt-3">
                ...
                <div>
                  <a href="/" className="text-decoration-none d-inline-flex align-items-center text-muted small">
                ...
                <div className="mt-3">
                  <div className="d-inline-flex align-items-center bg-light rounded-pill px-3 py-1">
                    <FaShieldAlt className="me-2 text-primary" size={12} />
