        ...
        <Navbar.Collapse id="navbar-content">
          ...
          <Nav className="me-auto align-items-center gap-3">
            ...
            <Nav.Link
              as={Link}
              to="/services"
              className={`nav-link-custom ${isActive("/services") ? "active" : ""}`}
            >
              Services
            </Nav.Link>
            ...
            <Dropdown>
              <Dropdown.Toggle
                variant="link"
                className={`nav-link-custom dropdown-toggle-no-arrow ${isActive("/tickets") ? "active" : ""}`}
              >
                Tickets <FaChevronDown size={10} style={{ marginLeft: 4 }} />
              </Dropdown.Toggle>
              <Dropdown.Menu>
                <Dropdown.Item
                  as={Link}
                  to="/tickets/high"
                  className={isActive("/tickets/high") ? "active" : ""}
                >
                  High Priority
                </Dropdown.Item>
                <Dropdown.Item
                  as={Link}
                  to="/tickets/medium"
                  className={isActive("/tickets/medium") ? "active" : ""}
                >
                  Medium Priority
                </Dropdown.Item>
                <Dropdown.Item
                  as={Link}
                  to="/tickets/low"
                  className={isActive("/tickets/low") ? "active" : ""}
                >
                  Low Priority
                </Dropdown.Item>
              </Dropdown.Menu>
